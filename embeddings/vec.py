...
model_path = '/Users/Christine/Documents/cs/GoogleNews-vectors-negative300-SLIM.bin' # christine
# model_path = "/Users/julianafakhoury/Documents/BC/nlp_project/GoogleNews-vectors-negative300-SLIM.bin" # juliana
...
def make_embeddings(filename,character):
...
x, y = make_embeddings(your_path+'/bang.csv','Sheldon',bigmodel ) #dora
